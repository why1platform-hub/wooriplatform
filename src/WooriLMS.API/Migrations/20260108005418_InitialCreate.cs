    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillPrograms", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultantTimeSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConsultantTimeSlots_AspNetUsers_InstructorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProgramApplications_SkillPrograms_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "SkillPrograms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConsultantBookings_ConsultantTimeSlots_TimeSlotId",
                        column: x => x.TimeSlotId,
                        principalTable: "ConsultantTimeSlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProgramCourses_SkillPrograms_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "SkillPrograms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultantBookings_TimeSlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultantTimeSlots_InstructorId",
                table: "ConsultantTimeSlots",
                column: "InstructorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgramApplications_ProgramId_UserId",
